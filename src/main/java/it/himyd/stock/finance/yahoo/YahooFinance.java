...
package it.himyd.stock.finance.yahoo;
...
import it.himyd.stock.finance.yahoo.histquotes.HistQuotesRequest;
import it.himyd.stock.finance.yahoo.histquotes.Interval;
import it.himyd.stock.finance.yahoo.quotes.fx.FxQuote;
import it.himyd.stock.finance.yahoo.quotes.fx.FxQuotesRequest;
import it.himyd.stock.finance.yahoo.quotes.stock.StockQuotesData;
import it.himyd.stock.finance.yahoo.quotes.stock.StockQuotesRequest;
...
public class YahooFinance {
    ...
    /**
    * Sends a basic quotes request to Yahoo Finance. This will return a {@link it.himyd.stock.finance.yahoo.Stock} object
    * with its {@link it.himyd.stock.finance.yahoo.quotes.stock.StockQuote}, {@link it.himyd.stock.finance.yahoo.quotes.stock.StockStats}
    * and {@link it.himyd.stock.finance.yahoo.quotes.stock.StockDividend} member fields
    ...
    * @return           a {@link it.himyd.stock.finance.yahoo.Stock} object containing the requested information
    ...
    */
     ...
     * historical stock quote data. Including historical data will cause the {@link it.himyd.stock.finance.yahoo.Stock}
     * object's member field {@link it.himyd.stock.finance.yahoo.histquotes.HistoricalQuote} to be filled in
    ...
    * The Stock objects have their {@link it.himyd.stock.finance.yahoo.quotes.stock.StockQuote}, {@link it.himyd.stock.finance.yahoo.quotes.stock.StockStats}
    * and {@link it.himyd.stock.finance.yahoo.quotes.stock.StockDividend} member fields
    * filled in with the available data.
    * <p>
    ...
    */
     ...
     * objects their member field {@link it.himyd.stock.finance.yahoo.histquotes.HistoricalQuote} to be filled in
     * with the default past year term at monthly intervals.
     * <p>
     ...
     * Some common symbols can easily be found in the ENUM {@link it.himyd.stock.finance.yahoo.quotes.fx.FxSymbols}
