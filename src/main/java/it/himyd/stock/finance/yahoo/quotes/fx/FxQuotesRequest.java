...
package it.himyd.stock.finance.yahoo.quotes.fx;


import java.util.ArrayList;
import java.util.List;

import it.himyd.stock.finance.yahoo.Utils;
import it.himyd.stock.finance.yahoo.YahooFinance;
import it.himyd.stock.finance.yahoo.quotes.QuotesProperty;
import it.himyd.stock.finance.yahoo.quotes.QuotesRequest;
